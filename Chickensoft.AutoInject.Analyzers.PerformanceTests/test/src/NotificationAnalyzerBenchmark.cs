...
public class NotificationAnalyzerBenchmark
{
  ...
  public async Task NotificationAnalyzerNoViolationsBaseline()
  {
  ...
  [Benchmark]
  public async Task NotificationAnalyzerNoViolations()
  {

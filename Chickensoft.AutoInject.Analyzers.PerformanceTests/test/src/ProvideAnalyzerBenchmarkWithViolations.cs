...
public class ProvideAnalyzerBenchmarkWithViolations {
  ...
  public async Task ProvideAnalyzerWithViolationsBaseline() {
  ...
  [Benchmark]
  public async Task ProvideAnalyzerWithViolations() {
